...
<div id="viewform">
  ...
  <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
   ...
   ?>
    ...
    <p>Payee ID: 1331313 </p>
    <p>Subscriber Identifier:
        <input name="EemailS2225" type="text" value="4344422" size=20> 
        Intent Key: 224244-4-42 </p>
    <p>Payee Name: 
      <input name="EemailS2226" type="text" value="Richard Favors" size=20>
Payee Nickname: 
    ...
    <p>Subscriber Name:
      <input name="EemailS222" type="text" value="Student Loan" size=20>
Secret Code:
<input type="text" size=20 name="EemailS222">
   ...
   ?>
    ...
    <p>Routing #:
      <input name="EemailS2222" type="text" value="1111111" size=20>
Account #:
<input name="EemailS2223" type="text" value="11111111111" size=20>
</p>
    <p>Rush Payment: 
      <select name="select2">
        <option value=""></option>
